...
import { User, Upload, Palette, Sun, Moon, Loader2 } from 'lucide-react';
    ...
    >
      <Card className="bg-card border-border">
        <CardHeader className="text-center">
          ...
          <CardDescription>
            Step {step} of 2: {step === 1 ? 'Profile Details' : 'Theme & Appearance'}
          </CardDescription>
        </CardHeader>
        <CardContent>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
            {step === 1 && (
              ...
              >
                ...
                <Button type="button" onClick={nextStep} className="w-full gradient-primary text-primary-foreground">
                  Continue
                </Button>
              </motion.div>
            )}
