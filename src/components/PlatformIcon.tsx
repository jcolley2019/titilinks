...
// BIGO Live's mark is its mascot; reduced here to the head — rounded skull,
// scalloped back-crest, knocked-out eyes and smile — so it survives at 16px.
const BigoLiveIcon = makeBrandIcon('M5.41 19.85C2.29 19.92 1.06 17.36 3.97 14.51C-1.04 13.22 -0.89 10.07 4.23 9.35C0.49 5.58 2.12 2.94 6.89 5.01C5.95 0.62 8.43 -0.72 11.03 1.58A10.49 11.09 0 1 1 5.41 19.85ZM8.97 9.69A1.49 1.49 0 1 0 11.95 9.69A1.49 1.49 0 1 0 8.97 9.69ZM15.06 9.69A1.49 1.49 0 1 0 18.04 9.69A1.49 1.49 0 1 0 15.06 9.69ZM9.63 13.98Q13.68 18.99 17.74 13.98Q13.68 16.37 9.63 13.98Z');
...
const PLATFORMS: Record<string, PlatformMeta> = {
  ...
  'Bigo Live': { Icon: BigoLiveIcon, color: '#00FFEE' },
...
//     Snapchat #FFFC00 (1.07), Bigo Live #00FFEE (1.27), Buy Me a Coffee
//     #FFDD00 (1.35), Kick #53FC18 (1.37).
